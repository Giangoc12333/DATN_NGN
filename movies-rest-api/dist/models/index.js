...
exports.HistoryModel = exports.CountModel = exports.UserModel = exports.RatingModel = exports.MovieModel = exports.FavoriteModel = exports.CommentModel = void 0;
...
const history_model_1 = __importDefault(require("./history.model"));
...
var history_model_2 = require("./history.model");
Object.defineProperty(exports, "HistoryModel", { enumerable: true, get: function () { return __importDefault(history_model_2).default; } });
...
user_model_1.default.hasMany(history_model_1.default);
history_model_1.default.belongsTo(user_model_1.default, {
    foreignKey: "userId",
});
movie_model_1.default.hasMany(history_model_1.default);
history_model_1.default.belongsTo(movie_model_1.default, {
    foreignKey: "movieId",
});
